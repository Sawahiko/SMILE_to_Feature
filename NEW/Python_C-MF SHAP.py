...
#shap_loader = DataLoader(x_new, batch_size=100, shuffle=True)
...
#shap.plots.waterfall(shap_values[120], max_display=10)
shap.plots.beeswarm(shap_values)

# =============================================================================
# # order by feature's values
# df_initial = pd.read_excel("../DataTb.xlsx",sheet_name="AllDataSet")
# 
# new_df_shap =  pd.DataFrame(x_new.copy())
# new_y_shap = df_initial[["Tb"]]
# new_df_shap = pd.concat([new_df_shap, new_y_shap], axis=1)
# 
# #new_df_shap["Y"] = df[["Tb"]]
# 
# 
# order = np.argsort(new_df_shap["Tb"])
